...
In order to support loading of multiple wallets in worthless-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is worthless.cpp.
...
Changes to worthless.cpp
----------------------
worthless.cpp is the entry point into worthless-qt, and as such, will require some minor modifications to provide hooks for
