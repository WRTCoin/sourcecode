...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop worthless server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "worthless server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* worthless features */
        {"worthless", "masternode", &masternode, true, true, false},
        {"worthless", "listmasternodes", &listmasternodes, true, true, false},
        {"worthless", "getmasternodecount", &getmasternodecount, true, true, false},
        {"worthless", "masternodeconnect", &masternodeconnect, true, true, false},
        {"worthless", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"worthless", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"worthless", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"worthless", "masternodecurrent", &masternodecurrent, true, true, false},
        {"worthless", "masternodedebug", &masternodedebug, true, true, false},
        {"worthless", "startmasternode", &startmasternode, true, true, false},
        {"worthless", "createmasternodekey", &createmasternodekey, true, true, false},
        {"worthless", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"worthless", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"worthless", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"worthless", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"worthless", "getmasternodescores", &getmasternodescores, true, true, false},
        {"worthless", "mnbudget", &mnbudget, true, true, false},
        {"worthless", "preparebudget", &preparebudget, true, true, false},
        {"worthless", "submitbudget", &submitbudget, true, true, false},
        {"worthless", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"worthless", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"worthless", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"worthless", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"worthless", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"worthless", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"worthless", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"worthless", "checkbudgets", &checkbudgets, true, true, false},
        {"worthless", "mnsync", &mnsync, true, true, false},
        {"worthless", "spork", &spork, true, true, false},
        {"worthless", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> worthless-cli " + methodname + " " + args + "\n";
}
