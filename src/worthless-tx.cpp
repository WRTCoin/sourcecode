...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("worthless worthless-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  worthless-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded worthless transaction") + "\n" +
                               "  worthless-tx [options] -create [commands]   " + _("Create hex-encoded worthless transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded worthless transaction
