                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Worthless Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&worthless Project"), this);
    webmainAction->setStatusTip(tr("worthless Project Website"));
    ...
    facebookAction->setStatusTip(tr("worthless Facebook"));
    ...
    twitterAction->setStatusTip(tr("worthless Twitter"));
    ...
    discordAction->setStatusTip(tr("worthless Discord"));
    ...
    youtubeAction->setStatusTip(tr("worthless Youtube"));
    ...
    telegramAction->setStatusTip(tr("worthless Telegram"));
    ...
    redditAction->setStatusTip(tr("worthless Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap worthless"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell worthless Coin (worthless)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    worthlessBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&worthless block explorer"), this);
    worthlessBlockExplorerAction->setStatusTip(tr("worthless blockchain explorer"));
    worthlessBlockExplorerAction->setToolTip(worthlessBlockExplorerAction->statusTip());
    worthlessBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&worthless Project Github"), this);
    githubAction->setStatusTip(tr("worthless Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a worthless address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and worthless: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWRTC"));
...
//    }
    ...
    connect(worthlessBlockExplorerAction, SIGNAL(triggered()), this, SLOT(worthlessBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About worthless Core"), this);
    aboutAction->setStatusTip(tr("Show information about worthless Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for worthless"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your worthless addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified worthless addresses"));
    ...
    openAction->setStatusTip(tr("Open a worthless: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the worthless Core help message to get a list with possible worthless command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(worthlessBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("worthless Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.worthless.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/worthless.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/worthless4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/worthlesscryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/worthless-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::worthlessBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/worthless/worthless/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to worthless network", "", count));
}
...
{
    QString strTitle = tr("worthless Core"); // default title
