...
QString BitcoinUnits::id(int unit)
{
    ...
    case worthless:
        return QString("WRTC");
    case mECA:
        return QString("mWRTC");
    case uECA:
        return QString::fromUtf8("uWRTC");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case worthless:
            return QString("tWRTC");
        case mECA:
            return QString("mtWRTC");
        case uECA:
            return QString::fromUtf8("WRTC");
        default:
            return QString("???");
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case worthless:
            return QString("WRTC");
        case mECA:
            return QString("Milli-WRTC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-WRTC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case worthless:
            return QString("TestWRTC");
        case mECA:
            return QString("Milli-TestWRTC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestWRTC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
