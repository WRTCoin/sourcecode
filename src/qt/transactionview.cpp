 ...
 */
    ...
    typeWidget->addItem(tr("Received worthless from zWRTC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zWRTC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEca));
