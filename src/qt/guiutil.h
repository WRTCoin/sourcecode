...
/** Utility functions used by the worthless Qt UI.
 */
namespace GUIUtil
{
...
// Render worthless addresses in monospace font
...
// Parse "worthless:" URI into recipient object, return true on successful parsing
