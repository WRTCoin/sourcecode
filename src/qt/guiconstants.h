...
/* worthless GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "worthless"
#define QAPP_ORG_DOMAIN "worthlessproject.org"
#define QAPP_APP_NAME_DEFAULT "worthless-Qt"
#define QAPP_APP_NAME_TESTNET "worthless-Qt-testnet"
