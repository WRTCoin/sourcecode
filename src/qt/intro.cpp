...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("worthless Core"),
     ...
     * override -datadir in the worthless.conf file in the default data directory
     * (to be consistent with worthlessd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
