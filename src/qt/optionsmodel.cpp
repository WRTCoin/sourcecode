...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::worthless);
    ...
    if (!settings.contains("nAnonymizeworthlessAmount"))
        settings.setValue("nAnonymizeworthlessAmount", 1000);

    nAnonymizeworthlessAmount = settings.value("nAnonymizeworthlessAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeworthlessAmount"))
        SoftSetArg("-anonymizeworthlessamount", settings.value("nAnonymizeworthlessAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in worthless.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizeworthlessAmount:
            return QVariant(nAnonymizeworthlessAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizeworthlessAmount:
            nAnonymizeworthlessAmount = value.toInt();
            settings.setValue("nAnonymizeworthlessAmount", nAnonymizeworthlessAmount);
            emit anonymizeworthlessAmountChanged(nAnonymizeworthlessAmount);
            break;
        case CoinControlFeatures:
