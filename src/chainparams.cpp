...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "worthless is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1622420747;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 4432273;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xc9946351f970bb8805b765c8e0be9dbc8846a6f2b7471b9815f6f48aef356dbf"));
        assert(hashGenesisBlock == uint256("0x00000ffad3c661cb60672876395cd82ec8163fb72e94b887f2580b7ade79c56f"));

     
		
	vSeeds.push_back(CDNSSeedData("104.238.144.16","104.238.144.16"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xc9946351f970bb8805b765c8e0be9dbc8846a6f2b7471b9815f6f48aef356dbf"));
        assert(hashGenesisBlock == uint256("0x0000a5084016cee6e311b0d9d7f0e55ee4b2db8a979542b0343e964e66914b0f"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xc9946351f970bb8805b765c8e0be9dbc8846a6f2b7471b9815f6f48aef356dbf"));
        assert(hashGenesisBlock == uint256("0x7b441c82b2c65853d01b1aeef31aadb466a8a2c72834dfc3a91554d6952f171e"));
