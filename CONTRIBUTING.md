Contributing to worthless Core
============================

The worthless Core project operates an open contributor model where anyone is
...
The following applies to code changes to the worthless Core project, and is not to be
confused with overall worthless Network Protocol consensus changes.

Whether a pull request is merged into worthless Core rests with the project merge
...
Patches that change worthless consensus rules are considerably more involved than
...
Where a patch set proposes to change the worthless consensus, it must have been
...
The project leader is the release manager for each worthless Core release.
