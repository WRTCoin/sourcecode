...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/worthless-cli.cpp \
           src/worthless-tx.cpp \
           src/worthless.cpp \
           src/db.cpp \
           ...
           src/qt/worthless.cpp \
           src/qt/worthlessstrings.cpp \
...
RESOURCES += src/qt/worthless.qrc src/qt/worthless_locale.qrc

TRANSLATIONS += src/qt/locale/worthless_bg.ts \
                src/qt/locale/worthless_de.ts \
                src/qt/locale/worthless_en.ts \
                src/qt/locale/worthless_es.ts \
                src/qt/locale/worthless_fi.ts \
                src/qt/locale/worthless_fr.ts \
                src/qt/locale/worthless_it.ts \
                src/qt/locale/worthless_ja.ts \
                src/qt/locale/worthless_pl.ts \
                src/qt/locale/worthless_pt.ts \
                src/qt/locale/worthless_ru.ts \
                src/qt/locale/worthless_sk.ts \
                src/qt/locale/worthless_sv.ts \
                src/qt/locale/worthless_vi.ts \
                src/qt/locale/worthless_zh_CN.ts \
                src/qt/locale/worthless_zh_TW.ts
