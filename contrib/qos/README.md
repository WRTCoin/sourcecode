...
This means one can have an always-on worthlessd instance running, and another local worthlessd/worthless-qt instance which connects to this node and receives blocks from it.
